...
var InputMoment = function (_Component) {
  ...
  _createClass(InputMoment, [{
    ...
    value: function componentWillMount() {
      if ((0, _moment2.default)().format('llll').indexOf('PM') > -1) {
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          is12Hr = _props.is12Hr,
          props = _objectWithoutProperties(_props, ['moment', 'className', 'prevMonthIcon', 'nextMonthIcon', 'minStep', 'hourStep', 'onSave', 'onToggle', 'is12Hr']);
