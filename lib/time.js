...
var _class = function (_Component) {
  ...
  function _class() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _class.__proto__ || Object.getPrototypeOf(_class)).call.apply(_ref, [this].concat(args))), _this), _this.changeHours = function (pos) {
      ...
      m.hours(pos.x);
      _this.props.onChange(m, 'hours');
    }, _this.changeMinutes = function (pos) {
      var m = _this.props.moment;
      m.minutes(pos.x);
      _this.props.onChange(m, 'minutes');
    }, _this.onToggle = function (e) {
      var m = _this.props.moment;
      _this.setState({
        value: !_this.state.value
      });
      _this.props.onChange(m, 'changeAMPM');
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'showtime' },
          this.props.is12Hr ? _react2.default.createElement(
            'span',
            { className: 'time' },
            m.format('hh')
          ) : _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.props.is12Hr ? _react2.default.createElement(_reactToggle2.default, {
